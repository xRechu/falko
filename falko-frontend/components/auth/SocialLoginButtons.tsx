    ...
    <div className={`space-y-3 ${className}`}>
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="bg-white px-4 text-gray-500">lub zaloguj się</span>
        </div>
      </div>
      ...
      {providers.facebook && (
        ...
        >
          <Button
            variant="outline"
            className="w-full h-12 text-white bg-[#1877F2] border-[#1877F2] hover:bg-[#166FE5] transition-colors"
